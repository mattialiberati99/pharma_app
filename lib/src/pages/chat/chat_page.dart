          ...
          children: <Widget>[
            ...
            Expanded(
              child: Padding(
                ...
                child: AutoSizeText(
                  chat!.other!.name!,
                  //style: TextStyles.bigPrimaryLightBold,
                  maxLines: 1,
                ),
              ),
            ),
          ...
          InkWell(
              onTap: () => showDialog(
                  ...
                  builder: (_) => CustomDialog(
                      title: 'ciao',//S.current.delete_chat,
                      description: 'descrizione'//S.current.eliminated_for_both))
                  .then((value) async {
                if (value) {
                  var deleted =
                        ...
                        children: [
                          Expanded(
                            ...
                            child: DetectableTextField(
                              ...
                              decoratedStyle: TextStyle(color: Colors.black),
                              basicStyle: TextStyle(color: AppColors.primary),
