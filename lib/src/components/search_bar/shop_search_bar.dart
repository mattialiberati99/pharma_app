...
class SearchBarShop extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SearchBarShop> createState() => _SearchBarShopState();
}

class _SearchBarShopState extends ConsumerState<SearchBarShop> {
  @override
